...
export class InitialMigration1754311104439 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "character" ("id" SERIAL NOT NULL, "name" character varying(75) NOT NULL, "picture" character varying(250), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6c4aec48c564968be15078b8ae5" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_d80158dde1461b74ed8499e7d8" ON "character" ("name") `,
    );
    await queryRunner.query(
      `CREATE TABLE "actor" ("id" SERIAL NOT NULL, "firstName" character varying(50) NOT NULL, "lastName" character varying(50) NOT NULL, "picture" character varying(250), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_05b325494fcc996a44ae6928e5e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_92e0c1c260c269baca05671371" ON "actor" ("firstName", "lastName") `,
    );
    await queryRunner.query(
      `CREATE TABLE "author" ("id" SERIAL NOT NULL, "firstName" character varying(50) NOT NULL, "lastName" character varying(50) NOT NULL, "picture" character varying(250), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5a0e79799d372fe56f2f3fa6871" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "citation" ("id" SERIAL NOT NULL, "text" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "episodeId" integer, "movieId" integer, "characterId" integer NOT NULL, CONSTRAINT "PK_f02dfdce6c05dfbf2fead28d0b6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_58a6b31f9609466983c6bf55ff" ON "citation" ("text") `,
    );
    await queryRunner.query(
      `CREATE TABLE "movie" ("id" SERIAL NOT NULL, "name" character varying(75) NOT NULL, "releaseDate" date NOT NULL, "picture" character varying(250), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "showId" integer, CONSTRAINT "PK_cb3bb4d61cf764dc035cbedd422" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_cee7125f3cbad047d34a6e1353" ON "movie" ("name") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_39a1f9bad5d2eedf46f3008d36"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a276f6a5aded3bf01fc6a7ef66"`,
    );
    await queryRunner.query(`DROP TABLE "citation_author"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d484af57c60d97963f9265669f"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_66bce05a3da51d73d1896d609e"`,
    );
    await queryRunner.query(`DROP TABLE "citation_actor"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_329210c738ed6ca2581627b589"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_fcfe9360470f1a66baabbaaead"`,
    );
    ...
    await queryRunner.query(`DROP TYPE "public"."show_mediatype_enum"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4f7be22383ee689e458305612d"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4da334f952d24a0bf6a2902945"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cee7125f3cbad047d34a6e1353"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_cae5e33adeffb5e009874e8b7e"`,
    );
    await queryRunner.query(`DROP TABLE "author"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_92e0c1c260c269baca05671371"`,
    );
